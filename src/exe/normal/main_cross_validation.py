...
from src.utils.visualization import (plot_reconstruction_comparison, plot_cross_performance, plot_cross_training_history,
                                     plot_cv_attention_heads, plot_cv_highlighted_ecg_parts, plot_cross_confusion_matrices)
...
def main():
    ...
    train_data, test_data = load_mitbih_data_leakage()
    ...
    history = train_cv_classifier(encoded_all, X_all, Y_all, scaler, 50, patient_ids, 10, None)
